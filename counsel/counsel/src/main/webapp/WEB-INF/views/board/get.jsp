	...
	<div class="container w-75">
		...
		<form method="post">
			<div class="card px-4 pb-3">
				...
				<input type="text" class="form-control px-3 py-1" value="${board.counsel_writer} / ${board.counsel_userId}" readonly>
				...
				<input type="text" class="form-control px-3 py-1" value="${board.counsel_regDate} ${'(수정시간 :' ${board.counsel_regDate}')'}" readonly>
